...
import { ArrowRight, Users, Trophy, Sword, ExternalLink } from "lucide-react";
import { Navbar } from "@/components/layout/navbar";
import { Footer } from "@/components/layout/footer";
import { CloudBackground } from "@/components/clouds";
import { TierBadge } from "@/components/tier-badge";
import { useGetSiteStats, useGetTopPlayers, useListGamemodes } from "@workspace/api-client-react";
          ...
          <section className="max-w-5xl mx-auto px-4 pb-20">
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h2 className="text-2xl font-black text-white">Top Ranked Players</h2>
                  ...
                  >
                    <Link href={`/players/${entry.player.id}`}>
                      <div className={`relative rounded-xl border p-5 bg-black/50 backdrop-blur-sm hover:bg-black/70 transition-all cursor-pointer group ${
                        ...
                        <div className="absolute top-3 right-3 text-3xl font-black opacity-10 font-mono">
                          #{entry.rank}
                        </div>
